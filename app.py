...
def call_gemini(user_prompt, history, mode):
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            return {"answer": f"에러 발생 (Code: {resp.status_code})", "thought_flow": ["오류"], "dream_text": "회로가 꼬인 것 같아요."}
    except Exception as e:
        return {"answer": "연결에 실패했습니다.", "thought_flow": ["에러"], "dream_text": str(e)}
